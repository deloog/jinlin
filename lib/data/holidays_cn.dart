...
// 中国地区预设的特殊日期列表 (初步示例)
final List<SpecialDate> presetHolidaysCN = [
  // --- 法定节假日 ---
  SpecialDate(
    id: 'CN_NewYearDay',
    name: '元旦',
...
// 未来可以根据地区或其他条件筛选这里的列表
List<SpecialDate> getHolidaysForRegion(String regionCode) {
  return presetHolidaysCN.where((h) => h.regions.contains(regionCode) || h.regions.contains('ALL')).toList();
}